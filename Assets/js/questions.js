const questions = [
  ...
  {
    q: "What JS method that enables randomization?",
    a: ["Math.trunc()","Math.roll-dice()","Number.random()","Math.random()"],
    c: "Math.random()"
  },
  {
    q: "What does CSS stand for?",
    a: ["Crop and Soil Science","Circuit Switched Services","Cascading Style Sheet","Cross Site Scripting"],
  ...
  },
  {
    ...
    c: "Build the structure (like walls and floors)"
  },
  {
    q: "What special character stands in for jQuery functions?",
    a: ["☕","#","*","$"],
    c: "$"
  },
];
